          ...
          <Box>
            <Stepper activeStep={activeStep} orientation="vertical">
              <Step>
                ...
                <StepContent>
                   <DenomForm createDenom={createDenom} account={account} setDenom={setDenomId} setIsCreatingCollectionSucceed={setIsCreatingCollectionSucceed} setNextStep={handleNext}/>
                </StepContent>
              </Step>
              ...
              <Step>
                ...
                <StepContent>
                   <NftForm mintNft={mintNft} account={account} denomId={denomId} setIsMintingNFTSucceed={setIsMintingNFTSucceed}/>
                </StepContent>
              </Step>
            </Stepper>
